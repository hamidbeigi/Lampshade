...
window.CodeMirror = (function() {
  ...
  function handleKeyBinding(cm, e) {
    ...
    if (e.shiftKey) {
      ...
      // that, see if there is a cursor-motion RegisterModel (starting with
      ...
      if (display.input.selectionStart != null) {
        ...
        var i = 0, poll = function(){
          if (display.prevInput == "\u200b" && display.input.selectionStart == 0)
            operation(cm, RegisterModels.selectAll)(cm);
  ...
  CodeMirror.prototype = {
    ...
    execRegisterModel: function(cmd) {
      if (RegisterModels.hasOwnProperty(cmd))
        return RegisterModels[cmd](this);
    },
  ...
  // STANDARD RegisterModelS

  var RegisterModels = CodeMirror.RegisterModels = {
  ...
  // Note that the save and find-related RegisterModels aren't defined by
  // default. Unknown RegisterModels are simply ignored.
  keyMap.pcDefault = {
