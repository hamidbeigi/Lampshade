    ...
    $.get(url,
        ...
        function (htmlPage) {
            ...
            if (tinymce.get('ProductDescription')) {
                tinymce.get('ProductDescription').remove();
            }
...
$.validator.addMethod("maxfilesize", function (value, element, param) {
    ...
    return element.files[0].size <= param; // param از C# میاد (مثلاً 1048576)
});

$.validator.unobtrusive.adapters.addSingleVal("maxfilesize", "max");



$.validator.addMethod("fileextentionlimitation", function (value, element, param) {
    if (element.files.length === 0) return true;
...
$.validator.unobtrusive.adapters.addSingleVal("fileextentionlimitation", "extensions");
